...
@agent_router.get("/dashboard/agent/trainees", dependencies=[Depends(has_roles("agent"))])
...
# @agent_router.get("/dashboard/agent/trainee/{trainee_id}/progress", dependencies=[Depends(has_roles("agent"))])
...
@agent_router.get("/dashboard/agent/resources", dependencies=[Depends(has_roles("agent"))])
...
@agent_router.get("/dashboard/agent/tasks", dependencies=[Depends(has_roles("agent"))])
...
@agent_router.post("/dashboard/agent/tasks/assign", dependencies=[Depends(has_roles("agent"))])
def assign_task(
...
@agent_router.delete("/dashboard/agent/tasks/remove", dependencies=[Depends(has_roles("agent"))])
def remove_task(
    user_id: Annotated[str, Depends(is_authenticated)],
...
@agent_router.get("/dashboard/agent/transcript/{trainee_id}", dependencies=[Depends(has_roles("agent"))])
